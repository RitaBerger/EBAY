...
def test_create_product():
    ...
    my_headers = {"Authorization" : "Bearer 538u95837fgkljhdefjigy34r978ty4538gyh"}
    response = requests.post("https://dummyjson.com/products/add", data=test_data, headers=my_headers)
